...
def begin_training(model, begin_at_epoch=0):
	...
	fit = model.fit_generator(generator(training_samples, batch_size),
							  samples_per_epoch=samples_per_epoch,
							  nb_epoch=n_epoch, verbose=2,
							  callbacks=[model_checkpoint, early_stopping, reduce_LR_plateau, tensorboard_log],
